...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','app.py',83),
  ('statement -> expression','statement',1,'p_statement_expr','app.py',87),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','app.py',93),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','app.py',94),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','app.py',95),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','app.py',96),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','app.py',103),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','app.py',107),
  ('expression -> NUMBER','expression',1,'p_expression_number','app.py',111),
  ('expression -> NAME','expression',1,'p_expression_name','app.py',115),
]
